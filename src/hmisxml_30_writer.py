...
#  File "hmisxml_30_writer.py", line 1576, in <module>
#    vld.write()        
#  File "hmisxml_30_writer.py", line 366, in write
#    self.processXML()
#  File "hmisxml_30_writer.py", line 1488, in processXML
#    export = self.customizeExport(export, exportRecs)
#  File "hmisxml_30_writer.py", line 1324, in customizeExport
#    if exportData.source_id_id_id_num_2010 == "" or exportData.source_id_id_id_num_2010 is None:
#AttributeError: 'list' object has no attribute 'source_id_id_id_num_2010'
		
		if exportData.source_id_id_id_num_2010 == "" or exportData.source_id_id_id_num_2010 is None:
			IDStr.text = exportData.source_id_id_id_str_2010
		else:
			IDStr.text = exportData.source_id_id_id_num_2010
	...
	def processXML(self):
		...
		for sourceData in Sources:
			...
			agency = self.customizeAgency(agency)
