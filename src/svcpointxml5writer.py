...
class SvcPointXML5Writer():
    ...
    def customizeGoal(self, goal):
		...
		ET.SubElement(goal, "status")
		ET.SubElement(goal, "target_date")
		ET.SubElement(goal, "outcome")
		ET.SubElement(goal, "outcome_date")
		ET.SubElement(goal, "projected_followup_date")
		ET.SubElement(goal, "followup_made")
    ...
    def customizeAction_step(self, action_step):
		...
		ET.SubElement(action_step, "status")
		ET.SubElement(action_step, "target_date")
		ET.SubElement(action_step, "outcome")
		ET.SubElement(action_step, "outcome_date")
		ET.SubElement(action_step, "projected_followup_date")
...
#			svpprofdob.text = dateutils.fixDate(self.person.person_date_of_birth_unhashed)
    ...
    def calcHourlyWage(self, monthlyWage):
		if monthlyWage <> "":
			...
			#else:
				#hourlyWage = 0.00#IGNORE:@UnusedVariable
		else:
			hourlyWage = 0.00
