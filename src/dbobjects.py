...
#        return
    ...
    # SBB2009119 adding a reported column.  Hopefully this will append the column to the table def.
        ...
        ## HUD 3.0
        Column('person_index_id_2010', Integer, ForeignKey(Person.id)),
        Column('need_index_id_2010', Integer, ForeignKey(Need.id)),
        Column('service_event_id_delete_2010', String(32)),
    ...
    # dbCol: taxonomy
        ...
        ## HUD 3.0
        Column('person_index_id_2010', Integer, ForeignKey(Person.id)),
        Column('need_id_delete_2010', String(32)),
    ...
    #    Column('va_eligibility_date_collected', DateTime(timezone=True)),
        ...
        ## HUD 3.0
        Column('site_service_participation_id_delete_2010', String(32)),
    ...
    def races_map(self):
        ...
        ## HUD 3.0
        Column('race_data_collection_stage_2010', String(32)),
    ...
    def other_names_map(self):
        ...
        Column('other_first_name_data_collection_stage_2010', String(32)),
        ...
        Column('other_middle_name_data_collection_stage_2010', String(32)),
        ...
        Column('other_last_name_data_collection_stage_2010', String(32)),
        ...
        Column('other_suffix_data_collection_stage_2010', String(32)),
    ...
    def person_address_map(self):
        ...
        Column('pre_address_line_data_collection_stage_2010', String(32)),
        ...
        Column('line1_data_collection_stage_2010', String(32)),
        ...
        Column('county_data_collection_stage_2010', String(32)),
        ...
        Column('state_data_collection_stage_2010', String(32)),
        ...
        Column('zipcode_data_collection_stage_2010', String(32)),
        ...
        Column('country_data_collection_stage_2010', String(32)),
        ...
        Column('is_last_permanent_zip_data_collection_stage_2010', String(32)),
        ...
        Column('zip_quality_code_data_collection_stage_2010', String(32)),
        
        # SBB2009119 adding a reported column.  Hopefully this will append the column to the table def.
        Column('reported', Boolean),

        ## HUD 3.0
        Column('attr_delete_2010', String(32)),
    ...
    def person_map(self):
        ...
        Column('id', Integer, primary_key=True),
        Column('export_id', String(50), ForeignKey(Export.export_id)),
        ...
        Column('person_id_delete_2010', String(32)),
        ...
        Column('person_date_of_birth_hashed_delete_2010', String(32)),
        ...
        Column('person_date_of_birth_unhashed_delete_2010', String(32)),
        ...
        Column('person_ethnicity_hashed_delete_2010', String(32)),
        ...
        Column('person_ethnicity_unhashed_delete_2010', String(32)),
        ...
        Column('person_gender_hashed_delete_2010', String(32)),
        ...
        Column('person_gender_unhashed_delete_2010', String(32)),
        ...
        Column('person_legal_first_name_hashed_delete_2010', String(32)),
        ...
        Column('person_legal_first_name_unhashed_delete_2010', String(32)),
        ...
        Column('person_legal_last_name_unhashed_delete_2010', String(32)),
        ...
        Column('person_legal_last_name_hashed_delete_2010', String(32)),
        ...
        Column('person_legal_middle_name_hashed_delete_2010', String(32)),
        ...
        Column('person_legal_middle_name_unhashed_delete_2010', String(32)),
        ...
        Column('person_legal_suffix_hashed_delete_2010', String(32)),
    ...
    #    Column('visually_impaired_date_collected', DateTime(timezone=True)),
        ...
        ## HUD 3.0
        Column('person_historical_id_delete_2010', String(32)),
    ...
    def income_and_sources_map(self):
        ...
        Column('income_and_source_id_id_delete_2010', String(32)),
        Column('income_source_code_data_collection_stage_2010', String(32)),
        Column('income_source_other_data_collection_stage_2010', String(32)),
        Column('receiving_income_source_2010', Integer),
        Column('receiving_income_source_data_collection_stage_2010', String(32)),
        Column('income_source_amount_data_collection_stage_2010', String(32)),
    ...
    # dbCol: release_granted
        ...
        ## HUD 3.0
        Column('release_of_information_id_data_collection_stage_2010', String(32)),
        Column('release_of_information_id_date_effective_2010', DateTime(timezone=True)),
        Column('documentation_data_collection_stage_2010', String(32)),
        Column('documentation_date_effective_2010', DateTime(timezone=True)),
        Column('release_granted_data_collection_stage_2010', String(32)),
    ...
    def source_map(self):
        ...
        Column('source_id_id_delete_2010', String(32)),
        ...
        Column('source_contact_email_2010', String(255)),
...
#))
    ...
    def source_export_link_2010_map(self):
        ...
        Column('export_index_id', String(50), ForeignKey(Export.export_id)),
    ...
    def assignment_2010_map(self):
        ...
        Column('assignment_id_delete', String(32)),
    ...
    def child_enrollment_status_2010_map(self):
        ...
        Column('child_enrollment_status_id_delete', String(32)),
    ...
    def child_enrollment_status_barrier_2010_map(self):
        ...
        Column('barrier_id_delete', String(32)),
    ...
    def contact_made_2010_map(self):
        ...
        Column('contact_id_delete', String(32)),
...
#        return
    ...
    def non_cash_benefits_2010_map(self):
        ...
        Column('non_cash_benefit_id_id_delete', String(32)),
...
#        return
    ...
    def pit_count_set_2010_map(self):
        ...
        Column('pit_count_set_id_delete', String(32)),
    ...
    def pregnancy_2010_map(self):
        ...
        Column('pregnancy_id_id_delete', String(32)),
    ...
    def degree_2010_map(self):
        ...
        Column('degree_id_delete', String(32)),
    ...
    def prior_residence_2010_map(self):
        ...
        Column('prior_residence_id_id_id_str', String(32)),
        Column('prior_residence_id_id_delete', String(32)),
    ...
    def destinations_2010_map(self):
        ...
        Column('destination_id_delete', String(32)),
    ...
    def reasons_for_leaving_2010_map(self):
        ...
        Column('reason_for_leaving_id_delete', String(32)),
    ...
    def domestic_violence_2010_map(self):
        ...
        Column('dv_occurred_date_collected', DateTime(timezone=True)),
        Column('dv_occurred_date_effective', DateTime(timezone=True)),        
    ...
    def employment_2010_map(self):
        ...
        Column('employment_id_id_delete', String(32)),
    ...
    def hmis_asset_2010_map(self):
        ...
        Column('asset_id_delete', String(32)),
    ...
    def veteran_military_branches_2010_map(self):
        ...
        Column('military_branch_id_id_delete', String(32)),
    ...
    def veteran_warzones_served_2010_map(self):
        ...
        Column('war_zone_id_id_delete', String(32)),
