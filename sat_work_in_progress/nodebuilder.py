...
# for validation
from selector import HUDHMIS28XMLTest, HmisCsv30Test, JFCSXMLTest, VendorXMLTest, SVCPOINTXMLTest
...
class NodeBuilder(DBObjects.databaseObjects):
    ...
    def __init__(self, queryOptions):
        ...
        # This doesn't appear to be needed for CSV, so commented out to speed testing:
