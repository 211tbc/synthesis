...
class HMISXMLWriter(DBObjects.databaseObjects):
	...
	def customizeAgency(self, xml, agencyData):
	    #sourceID = ET.SubElement(xml, "hmis:SourceID")
	    ...
	    # FIXME
	    #self.customizeAgencyAKA(theElements['AKA'], agencyData)
	    
	    
	    #theElements['AgencyLocation'].text = agencyData.
	...
	def customizeAgencyAKA(self, xml, agencyData):
	    # next process the elements
	    elements = [
		    'Name',
		    'Confidential',
